...
for(var x=0;x<Object.values(fish_red).length;x++) {
    tempImg[x] = new Image()
    tempImg[x].src = Object.values(fish_red)[x]
}
for(var x=0;x<Object.values(fish_orange).length;x++) {
    tempImg[x] = new Image()
    tempImg[x].src = Object.values(fish_orange)[x]
}
for(var x=0;x<Object.values(fish_yellow).length;x++) {
    tempImg[x] = new Image()
    tempImg[x].src = Object.values(fish_yellow)[x]
}
for(var x=0;x<Object.values(fish_green).length;x++) {
    tempImg[x] = new Image()
    tempImg[x].src = Object.values(fish_green)[x]
}
